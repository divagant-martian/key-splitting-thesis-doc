...
\chapter{Preliminaries
  ...
  \subsubsection{State Management}% TODO agregar referencias de los stateless y al survey en lo de externalización
...
%TODO cambiar lo de stateless a que en la literatura hay ejemplos pero no son muy usados porque limitan la expresividad de los casos de uso.

   %TODO Cómo se manej el estado importa porque afecta las estrategias de recuperación ante fallas y
