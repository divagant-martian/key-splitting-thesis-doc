...
% Why does it matter
  ...
  % Los datos se producen demasiado rápido y por tanto su volumen es demasiado grande para almacenarlos. Además su relevancia disminuye con el tiempo y los resultados se requieren muy pronto

% Stream Sources
  Stream Sources  \cite{kamburugamuve2013survey}
  % Dar ejemplos como sensores y etc. Mirar la fuente

% Data Stream Applications
  Data Stream Applications\cite{chakravarthy2009stream}
  % Dar ejemplos de monitoreo de aplicaciones, de análisis de eventos complejos en stock market. Dar ejemplos de productos que depende del procesamiento de este tipo de datos
