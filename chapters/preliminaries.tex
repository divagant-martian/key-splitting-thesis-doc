...
\chapter{Preliminaries
  ...
  The process through which \fref{fig:dag} becomes \fref{fig:physical-plan} includes a series of optimizations. It is possible to reorder, combine, divide and eliminate operators and still obtain the same desired results. \cite{Hirzel_2014} provides a comprehensive survey on these optimizations.
